...
!function(o) {
    "object" == ("undefined" == typeof exports ? "undefined" : e(exports)) && "undefined" != typeof module ? module.exports = o() : "function" == typeof define && define.amd ? define([], o) : ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).markdownitSup = o();
}(function() {
    return function o(e, n, t) {
        ...
        1: [ function(o, e) {
            function n(o, e) {
                ...
                if (94 !== o.src.charCodeAt(i)) return !1;
                if (e) return !1;
                if (i + 2 >= f) return !1;
                ...
                !1) : (o.posMax = o.pos, o.pos = i + 1, u = o.push("sup_open", "sup", 1), u.markup = "^", 
                u = o.push("text", "", 0), u.content = r.replace(t, "$1"), u = o.push("sup_close", "sup", -1), 
                u.markup = "^", o.pos = o.posMax + 1, o.posMax = f, !0) : (o.pos = i, !1);
            }
            var t = /\\([ \\!"#$%&'()*+,.\/:;<=>?@[\]^_`{|}~-])/g;
            e.exports = function(o) {
                o.inline.ruler.after("emphasis", "sup", n);
            };
        }, {} ]
    }, {}, [ 1 ])(1);
});