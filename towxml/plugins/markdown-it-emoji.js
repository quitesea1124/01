...
!function(a) {
    "object" == ("undefined" == typeof exports ? "undefined" : e(exports)) && "undefined" != typeof module ? module.exports = a() : "function" == typeof define && define.amd ? define([], a) : ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).markdownitEmoji = a();
}(function() {
            ...
            e.exports = function(a, e, n, o, i) {
                function r(a, o, r) {
                    ...
                    return a.replace(i, function(o, i, c) {
                        ...
                        i > t && (_ = new r("text", "", 0), _.content = a.slice(t, i), l.push(_)), (_ = new r("emoji", "", 0)).markup = u, 
                        _.content = e[u], l.push(_), t = i + o.length;
                    }), t < a.length && (_ = new r("text", "", 0), _.content = a.slice(t), l.push(_)), 
                    l;
                }
                var _ = a.utils.arrayReplaceAt, t = a.utils.lib.ucmicro, s = new RegExp([ t.Z.source, t.P.source, t.Cc.source ].join("|"));
                return function(a) {
                    var e, n, i, t, s, l = a.tokens, c = 0;
                    for (n = 0, i = l.length; n < i; n++) if ("inline" === l[n].type) for (t = l[n].children, 
                    e = t.length - 1; e >= 0; e--) "link_open" !== (s = t[e]).type && "link_close" !== s.type || "auto" === s.info && (c -= s.nesting), 
                    "text" === s.type && o.test(s.content) && 0 === c && (l[n].children = t = _(t, e, r(s.content, s.level, a.Token)));
                };
            };
        }, {} ],
        6: [ function(a, e, n) {
            var o = a("./lib/data/full.json"), i = a("./lib/data/shortcuts"), r = a("./lib/render"), _ = a("./lib/replace"), t = a("./lib/normalize_opts");
            e.exports = function(a, e) {
                var n = {
                    defs: o,
                    shortcuts: i,
