...
}, r = "function" == typeof Symbol && "symbol" == e(Symbol.iterator) ? function(r) {
...
!function(e) {
    "object" == ("undefined" == typeof exports ? "undefined" : r(exports)) && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).markdownit = e();
}(function() {
    return function e(r, t, n) {
        ...
        4: [ function(e, t, n) {
            ...
            var u = Object.prototype.hasOwnProperty, p = /\\([!"#$%&'()*+,\-.\/:;<=>?@[\\\]^_`{|}~])/g, h = new RegExp(p.source + "|" + /&([a-z#][a-z0-9]{1,31});/gi.source, "gi"), f = /^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))/i, d = e("./entities"), m = /[&<>"]/, _ = {
                "&": "&amp;",
                "<": "&lt;",
                ">": "&gt;",
                '"': "&quot;"
            }, g = e("uc.micro/categories/P/regex");
            n.lib = {}, n.lib.mdurl = e("mdurl"), n.lib.ucmicro = e("uc.micro"), n.assign = function(e) {
                return Array.prototype.slice.call(arguments, 1).forEach(function(t) {
                    if (t) {
                        if ("object" != (void 0 === t ? "undefined" : r(t))) throw new TypeError(t + "must be object");
                ...
                !function(o) {
                    ...
                    function l(e) {
                        return i(e, function(e) {
                            var r = "";
                            return e > 65535 && (e -= 65536, r += w(e >>> 10 & 1023 | 55296), e = 56320 | 1023 & e), 
                            r += w(e);
                        }).join("");
                    }
                    function u(e) {
                    ...
                    function f(e) {
                        ...
                        for (o = t > 0 ? t + 1 : 0; o < _; ) {
                            ...
                            g += p * a, f = c <= k ? 1 : c >= k + 26 ? 26 : c - k, !(p < f); c += 36) a > A(v / (d = 36 - f)) && s("overflow"), 
                            a *= d;
                    ...
                    function d(e) {
                        var r, t, n, o, i, a, l, u, f, d, m, _, g, b, k, y = [];
                        for (_ = (e = c(e)).length, r = 128, t = 0, i = 72, a = 0; a < _; ++a) (m = e[a]) < 128 && y.push(w(m));
                        for (n = o = y.length, o && y.push("-"); n < _; ) {
                            ...
                            a = 0; a < _; ++a) if ((m = e[a]) < r && ++t > v && s("overflow"), m == r) {
                                for (u = t, f = 36; d = f <= i ? 1 : f >= i + 26 ? 26 : f - i, !(u < d); f += 36) k = u - d, 
                                b = 36 - d, y.push(w(p(d + k % b, 0))), u = A(k / b);
                    ...
                    var m = "object" == (void 0 === n ? "undefined" : r(n)) && n && !n.nodeType && n, _ = "object" == (void 0 === t ? "undefined" : r(t)) && t && !t.nodeType && t, g = "object" == (void 0 === e ? "undefined" : r(e)) && e;
                    g.global !== g && g.window !== g && g.self !== g || (o = g);
                    var b, k, v = 2147483647, y = /^xn--/, x = /[^\x20-\x7E]/, C = {
                    ...
                    }, 1) if (m && _) if (t.exports == m) _.exports = b; else for (k in b) b.hasOwnProperty(k) && (m[k] = b[k]); else o.punycode = b; else (void 0)("punycode", function() {
                        return b;
                    });
                }(this);
